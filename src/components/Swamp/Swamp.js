...
function Swamp({currentPet}){
    ...
    //     console.log("current:", currentPet)
    //     if (updatedPet.health >= 90) {
    //         setUpdatedPet({...updatedPet, health: 100})
    //     }
    //     else {
    //         setUpdatedPet({...updatedPet, health: updatedPet.health + 10})
    //     }
    //     setUpdatedHappiness(parseInt((updatedPet.health + updatedPet.hunger + updatedPet.thirst + updatedPet.boredom) /4))
    //     console.log("updated:", updatedPet)
    //     console.log(updatedHappiness)
    ...
    //     console.log("current:", currentPet)
    //     if (updatedPet.hunger >= 90) {
    //         setUpdatedPet({...updatedPet, hunger: 100})
    //     }
    //     else {
    //         setUpdatedPet({...updatedPet, hunger: updatedPet.hunger + 10})
    //     }
    //     setUpdatedHappiness(parseInt((updatedPet.health + updatedPet.hunger + updatedPet.thirst + updatedPet.boredom) /4))
    //     console.log("updated:", updatedPet)
    //     console.log(updatedHappiness)
    ...
    //     console.log("current:", currentPet)
    //     if (updatedPet.thirst >= 90) {
    //         setUpdatedPet({...updatedPet, thirst: 100})
    //     }
    //     else {
    //         setUpdatedPet({...updatedPet, thirst: updatedPet.thirst + 10})
    //     }
    //     setUpdatedHappiness(parseInt((updatedPet.health + updatedPet.hunger + updatedPet.thirst + updatedPet.boredom) /4))
    //     console.log("updated:", updatedPet)
    //     console.log(updatedHappiness)
    ...
    //     console.log("current:", currentPet)
    //     if (updatedPet.boredom >= 90) {
    //         setUpdatedPet({...updatedPet, boredom: 100})
    //     }
    //     else {
    //         setUpdatedPet({...updatedPet, boredom: updatedPet.boredom + 10})
    //     }
    //     setUpdatedHappiness(parseInt((updatedPet.health + updatedPet.hunger + updatedPet.thirst + updatedPet.boredom) /4))
    //     console.log("updated:", updatedPet)
    //     console.log(updatedHappiness)
